...
Matrix, DI-MGMT-82133A). A digest is available in the ICM templates repository at
`Templates/advanced-options/DIDs/` — see its `GUIDE.md` for related requirement
